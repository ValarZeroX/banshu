    ...
    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4">
        ...
        <div class="col">
            <div class="card">
                ...
                <div class="card-body">
                    <p>{{ __('description.bmr')}}</p>
                </div>
                <div class="card-footer text-center">
                    <div class="btn-group">
                        <a href="/{{ app()->getLocale() }}/health/bmr" class="btn btn-sm btn-outline-secondary"
                            role="button">{{ __('banshus.proceed')}}</a>
                    </div>
                </div>
            </div>
        ...
        <div class="col">
            <div class="card">
                ...
                <div class="card-body">
                    <p>{{ __('description.tdee')}}</p>
                </div>
                <div class="card-footer text-center">
                    <div class="btn-group">
                        <a href="/{{ app()->getLocale() }}/health/tdee" class="btn btn-sm btn-outline-secondary"
                            role="button">{{ __('banshus.proceed')}}</a>
                    </div>
                </div>
            </div>
